              ...
              <div class="firma-instrucciones">
                <div class="info-box">
                  ...
                  <div class="info-content">
                    ...
                    <p>Una vez completado el formulario y adjuntada su firma, se generará automáticamente un documento oficial con todos los datos ingresados. Este proceso se realizará mediante automatizaciones y el documento final incluirá su firma digital.</p>
                  </div>
                </div>
              </div>
              ...
              <div class="plantilla-preview">
                ...
                <div class="preview-container">
                  <div class="preview-notice">
                    ...
                    <span>Esta es solo una vista previa de la plantilla. El documento final se generará y enviará a su correo automáticamente con sus datos.</span>
                  </div>
                  <div class="preview-document">
                    <iframe src="assets/docs/DeclaracionAV.pdf" 
                            width="100%" 
                            height="600px" 
                            style="border: 1px solid #ddd; border-radius: 8px;">
                      <p>Su navegador no soporta la visualización de PDFs. 
                         <a href="assets/docs/DeclaracionAV.pdf" target="_blank">Haga clic aquí para descargar el documento</a>
                      </p>
                    </iframe>
                    <small style="display: block; margin-top: 10px; color: #666;">Documento de prueba - El documento final contendrá todos los datos del formulario junto con su firma digital</small>
                  </div>
                </div>
              </div>
                ...
                <div class="firma-instructions">
                  <div class="instruction-box">
                    ...
                    <div class="instruction-content">
                      ...
                      <ul>
                        <li>Complete sus datos personales (Nombre completo y RUT)</li>
                        <li>Adjunte su firma digital en formato PNG o JPG</li>
                ...
                <div class="identification-fields">
                  <div class="form-row">
                    <div class="form-group">
                      ...
                      <input type="text" 
                             id="declarante-nombre" 
                             name="declarante-nombre" 
                             class="form-control" 
                             placeholder="Ingrese su nombre completo"
                             required>
                      <div class="input-hint">Nombre y apellidos como aparecen en su cédula de identidad</div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-error" id="rut-error" style="display: none;">RUT inválido. Verifique el formato y dígito verificador.</div>
                    </div>
                  </div>
                </div>
